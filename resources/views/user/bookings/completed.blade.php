...
<body>
    ...
    <div class="container container-bordered">
        ...
        <h2 class="text-center mb-4"><i class="fas fa-check-circle"></i> Completed Bookings</h2>
...
@endphp
            ...
            @if ($bookings->isEmpty())
                <div class="col-12">
                    <div class="empty-state">
                        ...
                        <h5 class="mt-3">No Completed Bookings</h5>
                        <p>You haven't completed any service appointments yet. Check your accepted bookings.</p>
                    </div>
                </div>
            @else
                @foreach ($bookings as $booking)
                    @php
                        $statusMessage = (!empty(trim($booking->status_msg)) && trim($booking->status_msg) !== 'Booking has been placed.')
                            ...
                            : 'This booking has been successfully completed. Thank you!';

                        $hasRated = \App\Models\ServiceRating::where('booking_id', $booking->id)
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                        ...
                        <div class="card booking-card">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Rating Section -->
                                <a href="{{ route('user.bookings.show', $booking->id) }}" class="rating-section-link">
    <div class="rating-section">
        ...
        @else
            <div class="already-rated">
                <i class="fas fa-check-circle"></i> You've rated this service
            </div>
        @endif
    </div>
</a>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('a[href*="#rateSection"]').click(function(event){
